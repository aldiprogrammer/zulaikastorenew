                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="form-material" method="post" action="{{ route('shiftkerja.create') }}">
                                            @csrf
                                            <div class="form-group form-primary">
                                                <input type="text" name="shiftkerja" class="form-control fill" required>
                                                <span class="form-bar"></span>
                                                <label class="float-label">Shift Kerja</label>
                                            </div>

                                            <div class="form-group form-primary">
                                                <input type="time" name="jam_masuk" class="form-control fill" required>
                                                <span class="form-bar"></span>
                                                <label class="float-label">Jam Masuk</label>
                                            </div>

                                            <div class="form-group form-primary">
                                                <input type="time" name="jam_keluar" class="form-control fill" required>
                                                <span class="form-bar"></span>
