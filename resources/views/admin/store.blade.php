                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-material" method="post" action="{{ route('store.create') }}">
                                                @csrf
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form class="form-material" method="post"
                                                                    action="{{ route('store.update', $item->id) }}">
                                                                    @csrf
                                                                    @method('PUT');
                                                ...
                                                <div class="modal fade" id="exampleHapus{{ $item->id }}"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form class="form-material" method="post"
                                                                    action="{{ route('store.delete', $item->id) }}">
                                                                    @csrf
                                                                    @method('delete')
